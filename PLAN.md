...
- [ ] feat: knayawp-send-to-terminal — send editor selection to the terminal panel (C-c k t) — #162
...
- [ ] refine: harden knayawp-claude-edit-style zoom (already-zoomed guard, per-frame winconf) + fix vacuous probe assertion — #163
