...
(let ((help-buf (get-buffer-create "*knayawp-sandbox*")))
  (with-current-buffer help-buf
    ...
    (insert
     ...
     "  C-c k l   knayawp-layout-setup     Create the layout\n"
     "  C-c k q   knayawp-layout-teardown  Remove the control pane\n"
     "\n"
     "Or use M-x:\n"
     "  M-x knayawp-layout-setup\n"
     "  M-x knayawp-layout-teardown\n"
     "\n"
     "Try this:\n"
     "  1. Press C-c k l to create the layout\n"
     "  2. Observe magit + terminal + claude panels on the right\n"
     "  3. Press C-x 1 — side windows survive!\n"
     "  4. Press C-c k q to tear down\n"
     "\n"
